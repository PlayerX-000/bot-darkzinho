...
try{
  let result = webp.buffer2webpbuffer(buffer,"jpg","-q 80")
  .then(async(date)=>{
        ...
        const sticker = await new Sticker(date, stickerMetadata).build()
        await conn.sendMessage(id,sticker ,funcbai.MessageType.sticker, { mimetype: funcbai.Mimetype.webp})
        ...
        // save to file
            ...
            m.message.videoMessage.fileLength < 250000
          ){
          ...
          const sticker = await new Sticker(bufferwebp, stickerMetadata).build()

              await conn.sendMessage(id, sticker, funcbai.MessageType.sticker);
